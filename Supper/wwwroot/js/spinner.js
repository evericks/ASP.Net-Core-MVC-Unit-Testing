        ...
        ! function (t, n) {
            ...
            function _e(e, t, n, r) {
                ...
                if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                    ...
                    if (s)
                        for (c = a[a.length - 1].ownerDocument, C.map(a, Ie), f = 0; f < s; f++) l = a[f], ye.test(l.type || "") && !J.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
